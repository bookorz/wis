...
public class RF_ContainerInfo {
	 ...
	 * Materila_List
	 */
	@Column("Materila_List")
	private String Materila_List;

	public String getMaterila_List() {
		return Materila_List;
	}

	public void setMaterila_List(String Materila_List) {
		this.Materila_List = Materila_List;
	}

	@Override
	public String toString() {
		return "RF_ContainerInfo [Container_ID=" + Container_ID + ", Container_Type=" + Container_Type
				+ ", Container_Status=" + Container_Status + ", Vendor_Name=" + Vendor_Name + ", StartTime=" + StartTime
				+ ", EndTime=" + EndTime + ", Car_ID=" + Car_ID + ", Fab=" + Fab + ", Area=" + Area + ", Gate=" + Gate
				+ ", Car_Type=" + Car_Type + ", ImpNo=" + ImpNo + ", Reason=" + Reason + ", DriverName=" + DriverName
				+ ", DriverPhone=" + DriverPhone + ", VendorID=" + VendorID + ", VendorCount=" + VendorCount
				+ ", CurrentStatus=" + CurrentStatus + ", CurrentAction=" + CurrentAction + ", Source=" + Source
				+ ", Process_Start=" + Process_Start + ", Process_End=" + Process_End + ", Process_Count="
				+ Process_Count + ", Current_Operation=" + Current_Operation + ", Materila_List=" + Materila_List + "]";
	}
